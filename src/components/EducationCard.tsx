...
const EducationCard: React.FC<EducationCardProps> = ({
  ...
  return (
    <div
      className={`p-3 sm:p-4 rounded-lg text-center md:text-left flex-shrink-0 cursor-pointer transition-all duration-300 hover:bg-opacity-80 w-[280px] sm:w-[400px] ${className}`}
      style={defaultStyle}
      onClick={onClick}
    >
      <div className='flex items-start gap-2 sm:gap-3 h-full'>
        ...
        <div className='flex-1 min-w-0'>
          ...
          <p className='text-xs sm:text-sm text-gray-200 mb-1'>{description}</p>
